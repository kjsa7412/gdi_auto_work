...
**cache로 해결 가능 시**: DB fallback 없이 원인 확정
**cache로 불가 시**: db_access.yml에 따라 DB fallback 허용 여부 판정

**결과 기록**: fix.manifest에 cache.used, cache.categories_used, cache.mismatch_detected, cache.db_fallback_used 기록
